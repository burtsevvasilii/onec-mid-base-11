...
Добавлены справочники КЛ_Должность и КЛ_КонтактныеЛица. В форму документа ЗаказПокупателя добавлен реквизит КЛ_СогласованнаяСкидка и доработана процедура подсчета суммы документа с учетом общей скидки и скидки, указанной в табличной части
